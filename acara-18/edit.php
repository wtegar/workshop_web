        ...
        ?>
            <form name="satu" action="update.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $data['nama']; ?>" placeholder="Masukan nama lengkap anda
                    dengan gelar">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="tlpn" id="tlpn" pattern="[0-9]{12}" onkeypress="return hanyaAngka(event)" class="form-control" value="<?php echo
                                                                                                                                                        $data['telpon']; ?>" placeholder="Masukan nomor telpon anda">
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat Anda:</label>
                    <input class="form-control" name="alamat" id="alamat" rows="3" value="<?php echo $data['alamat']; ?>" placeholder="Masukan alamat
                    anda"></input>
                </div>
                <div class="form-group">
